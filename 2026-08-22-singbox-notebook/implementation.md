...
- [x] 通读源档案：`2026-08-18-tailnet-exit-singbox/`（design/implementation/README/deploy 全部实体）+ frp / DERP / redroid 档案的关联条目 + 记忆 `moonlight-sunshine-tailscale-setup` 增补章节
- [x] 参照 `2026-08-21-sunshine-notebook/` 确定结构与约定（frontmatter + wikilink + 证据链留 plans）
