...
**Files:**
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/config.json`(发布到 `/etc/sing-box/config.json`)
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/rules/custom-direct.json`(发布到 `/etc/sing-box/rules/`)
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/rules/custom-proxy.json`(同上)
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/config.json`:
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/rules/custom-direct.json`(国内直连例外,示例已含一条注释示例;空规则合法):
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/rules/custom-proxy.json`(强制走代理例外):
...
**Files:**
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/tproxy.nft`(发布到 `/etc/sing-box/tproxy.nft`)
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/sing-box-tproxy.service`(发布到 `/etc/systemd/system/`)
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/99-exit-node.conf`(发布到 `/etc/sysctl.d/`)
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/tproxy.nft`:
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/sing-box-tproxy.service`:
...
`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/99-exit-node.conf`:
...
**Files:**
- Create: `~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/singbox-dns.conf`(发布到 `/etc/systemd/resolved.conf.d/`)

- [ ] **Step 1: 写 resolved 配置**

`~/plans/2026-08-18-tailnet-exit-singbox/sing-box-deploy/singbox-dns.conf`:
