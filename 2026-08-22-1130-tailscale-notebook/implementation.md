...
- **Notebook git 状态与既有档案的说法差异**：`2026-08-22-1024-singbox-notebook/design.md` 写"~/Notebook 不入 git"，该决策已于同日被用户要求推翻（初始导入 commit 9d08edc，private github.com/desmondc9/notebook，经 10809 代理 push）；本档案如实记录当前状态
