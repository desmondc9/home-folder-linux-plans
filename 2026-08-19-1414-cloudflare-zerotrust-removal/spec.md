...
- 2026-07 已把本机对外 SSH 从 Cloudflare Tunnel 迁到自建 frp(bandwagon VPS);2026-08-18 串流方案又加了自建 tailnet 主链路(见 [../2026-08-19-1302-sunshine-moonlight-tailnet/](../2026-08-19-1302-sunshine-moonlight-tailnet/))。CF Zero Trust 对本机已无任何价值,且 WARP 在中国大陆不可用(GFW 封 WARP/MASQUE 协议本身,2026-07 实测确认)。
...
- **目标 2**:把本机 frp 配置归档进本仓库——已独立成档,见 [../2026-08-19-1420-frp-config-archive/](../2026-08-19-1420-frp-config-archive/)。
...
- frp 配置快照归档 → 独立目录 [../2026-08-19-1420-frp-config-archive/](../2026-08-19-1420-frp-config-archive/)(最初落在本目录 `frp/`,同日移出)
...
`frpc.service`(enabled, running)→ `/usr/local/bin/frpc -c /etc/frp/frpc.toml`;对端 frps 在 bandwagon VPS(`bandwagon.signal-align.com:7000`,token auth)。**实体文件与详细说明已移至 [../2026-08-19-1420-frp-config-archive/](../2026-08-19-1420-frp-config-archive/)**,此处只留速览。
...
注意:~~`frpc.toml` 含 `auth.token`,本仓库为私人档案库,入库符合惯例~~ 认知已纠正——本仓库实为 GitHub **公开仓库**,token 曾因此泄露,2026-08-19 已从全部 git 历史清除并轮换,归档实体移至 [../2026-08-19-1420-frp-config-archive/](../2026-08-19-1420-frp-config-archive/)(已脱敏),事故记录见 [../2026-08-19-1528-frp-token-redaction/](../2026-08-19-1528-frp-token-redaction/)。
...
- [../2026-08-19-1302-sunshine-moonlight-tailnet/](../2026-08-19-1302-sunshine-moonlight-tailnet/) —— frp 作为串流备份链路的部署记录
- [../2026-08-19-1420-frp-config-archive/](../2026-08-19-1420-frp-config-archive/) —— frp 配置实体快照与运维说明
